...
const ProductCard = (props: Products) => {
  ...
  return (
    <div
      className="w-84 h-80 flex flex-col px-4 py-4 gap-2 border-2 rounded-lg cursor-pointer"
    ...
    >
      ...
      <div className="flex items-center justify-between">
        <h1 className="font-semibold text-base">{props.name}</h1>
      ...
      <p className="text-sm">{props.companyName}</p>
