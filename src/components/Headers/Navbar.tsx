...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full h-20 border-b shadow-2xs flex items-center justify-between px-4 md:px-12 z-9999999 bg-white">
      <div className="h-full flex items-center justify-center gap-6">
        <Menu
          className="block md:hidden h-7 w-7 cursor-pointer"
          strokeWidth={1}
        />
        <img
          src="/logo.png"
